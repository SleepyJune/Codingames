...
class MissionPlanner
{
    ...
    public void MakeMockTroop(Factory ally)
    {
        ...
        {
            if (troop.isAlly && troop.start == ally && troop.end == mockTroop.end)
            {
                mission.acceptedMission.Add(troop);
            }
        }*/
    }
}
