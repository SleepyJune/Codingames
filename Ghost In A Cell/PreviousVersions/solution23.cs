...
class Mission : IComparable<Mission>
{
    ...
    {
        return successRating >= MissionSuccessRating.Unlikely;
    }
...
class ReinforceMissionSolver : MissionSolver
{
    ...
    public void Solve()
    {
        ...
        if (mission.type == MissionType.Reinforce)
        {
            ...
            foreach (var t in mission.acceptedMission)
            {
                Console.Error.WriteLine("Reinforcement from " + t.start.id + ": " + t.count);
            }
...
class Strategy
{
    ...
    public static bool ExecuteMissions()
    {
        ...
        for (int i = 0; i < missions.Count;i++ )
        {
            ...
            Console.Error.WriteLine(mission.factory.id + ": " + mission.reward.combinedRewardWeighted);
